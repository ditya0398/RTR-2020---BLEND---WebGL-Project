...
var gbLighting_modelLoading=false;
var perspectiveProjectionMatrix_modelLoading;
...
function drawModel()
{
	...
	gl.uniformMatrix4fv(projectionUniform_modelLoading,false,perspectiveProjectionMatrix_modelLoading);
	...
	requestAnimationFrame(drawModel,canvas);
	console.log(i);
