...
function initNormalMapRoad() {
	...
	gl.bindAttribLocation(program, macros.DL_ATTRIB_POSITION, "vPosition")
	gl.bindAttribLocation(program, macros.DL_ATTRIB_NORMAL, "vNormal")
	gl.bindAttribLocation(program, macros.DL_ATTRIB_TEXCOORD, "vTexCoord")
	...
	var pos1 = Array(3.0, 0.0, 7.0)
	var pos2 = Array(-3.0, 0.0, 7.0)
	var pos3 = Array(-3.0, -0.0, -7.0)
	var pos4 = Array(3.0, -0.0, -7.0)
	...
	gl.vertexAttribPointer(macros.DL_ATTRIB_POSITION, 3, gl.FLOAT, false, 4 * 14, 0)
	gl.enableVertexAttribArray(macros.DL_ATTRIB_POSITION)
	gl.vertexAttribPointer(macros.DL_ATTRIB_NORMAL, 3, gl.FLOAT, false, 4 * 14, 4 * 3)
	...
	gl.vertexAttribPointer(macros.DL_ATTRIB_TEXCOORD, 2, gl.FLOAT, false, 4 * 14, 4 * 12)
...
function renderNormalMapRoad() {
	...
	gl.uniformMatrix4fv(projUniform, false, perspMat)
