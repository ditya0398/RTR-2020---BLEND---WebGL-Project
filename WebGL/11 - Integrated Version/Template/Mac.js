...
function ASJ_init_laptop() {
	...
	gl.bindAttribLocation(shaderProgramObject_laptop, WebGLMacrosASJ.ASJ_ATTRIBUTE_VERTEX, "vPosition");
	gl.bindAttribLocation(shaderProgramObject_laptop, WebGLMacrosASJ.ASJ_ATTRIBUTE_TEXTURE, "vTexCord");
	...
	gl.vertexAttribPointer(WebGLMacrosASJ.ASJ_ATTRIBUTE_VERTEX, 3, gl.FLOAT, false, 0, 0);
	gl.enableVertexAttribArray(WebGLMacrosASJ.ASJ_ATTRIBUTE_VERTEX);
	...
	gl.vertexAttribPointer(WebGLMacrosASJ.ASJ_ATTRIBUTE_TEXTURE, 2, gl.FLOAT,
		false, 0, 0);
