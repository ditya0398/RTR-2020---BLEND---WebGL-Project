...
function utensil_init()
{
    for (angle1_utensil = 0.0; angle1_utensil < 2 * 3.14; angle1_utensil = angle1_utensil + 0.001) {
        vertices_utensil[i_utensil++] = (Math.cos(angle1_utensil) * radius_utensil);
        vertices_utensil[i_utensil++] = (1.0);
        vertices_utensil[i_utensil++] = (Math.sin(angle1_utensil) * radius_utensil);

        vertices_utensil[i_utensil++] = (Math.cos(angle1_utensil) * radius_utensil);
        vertices_utensil[i_utensil++] = -2.0;
        vertices_utensil[i_utensil++] = (Math.sin(angle1_utensil) * radius_utensil);
...
function utensil_display()
{
    ...
    gl.uniformMatrix4fv(projectionMatrixUniform_utensil, false, perspectiveMatrix);
