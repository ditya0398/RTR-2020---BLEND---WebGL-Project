...
var ASJ_lightColorUniform_pointLight_model;
var ASJ_lightPositionUniform_pointLight_model;
var ASJ_shininessUniform_pointLight_model;
var ASJ_strengthUniform_pointLight_model;
var ASJ_eyeDirectionUniform_pointLight_model;
...
function initializeModel() {
    ...
    var vertexShaderSourceCode =
        ...
        //akhi
        "Position= u_modelMatrix * vPosition;" +
        "}";
    ...
    var fragmentShaderSource =
        ...
        " color = texture(diffuseMap, out_TexCoord);" +
        //Akhi Lighting Calculation
        "vec3 Normal_AJ=normalizedTNorm;" +
    ...
    //AKHI UNIFORM
    ASJ_ambientUniform_pointLight_model = gl.getUniformLocation(modelLoadingProgramObject, "Ambient_AJ");
    ASJ_lightColorUniform_pointLight_model = gl.getUniformLocation(modelLoadingProgramObject, "LightColor_AJ");
    ASJ_lightPositionUniform_pointLight_model = gl.getUniformLocation(modelLoadingProgramObject, "LightPosition_AJ");
    ASJ_shininessUniform_pointLight_model = gl.getUniformLocation(modelLoadingProgramObject, "Shininess_AJ");
    ASJ_strengthUniform_pointLight_model = gl.getUniformLocation(modelLoadingProgramObject, "Strength_AJ");
...
function drawModel() {
    ...
    //lightPosition_AJ[2]=
    gl.uniform4fv(ASJ_ambientUniform_pointLight_model, Ambient_AJ);
    gl.uniform3fv(ASJ_lightColorUniform_pointLight_model, LightColor_AJ);
    gl.uniform3fv(ASJ_lightPositionUniform_pointLight_model, lightPosition_AJ);
    gl.uniform1f(ASJ_shininessUniform_pointLight_model, shininess_AJ);
